...
const music = {
  ...
  lukeCage: {
    image:
      'https://firebasestorage.googleapis.com/v0/b/joozify.appspot.com/o/ImageURL%2FThai%2FSTAMP.jpg?alt=media&token=3eeb4780-8d3d-4d70-bcb4-eb7b8a315d1a',
    poster: lkPoster,
    title: 'Ohm Jong Ngoey',
    match: '93%',
    rating: 'STAMP',
    duration: '2m 44s',
    desc:
  ...
  PandR: {
    image:
      'https://firebasestorage.googleapis.com/v0/b/joozify.appspot.com/o/ImageURL%2FK-pop%2FITZ%20-%20icy.jpg?alt=media&token=de925f90-4af4-4f1c-8974-1c10325397c5',
    poster: parPoster,
    title: 'ICY',
    match: '100%',
    rating: 'IT-Z',
  ...
  thor: {
    image:
      'https://firebasestorage.googleapis.com/v0/b/joozify.appspot.com/o/ImageURL%2FK-pop%2FBTS_-_Lights_(w_DVD_Limited_Edition_-_Type_A).png?alt=media&token=a51c150f-0001-428e-9cbc-43d9a77d2d0a',
    poster: trPoster,
    title: 'Lightsk',
    match: '98%',
    rating: 'BTS',
  ...
  tlj: {
    image:
      'https://firebasestorage.googleapis.com/v0/b/joozify.appspot.com/o/ImageURL%2FK-pop%2FTwoFive.jpg?alt=media&token=6908fd24-0063-4580-aec2-76e05a002af2',
    poster: tljPoster,
    title: '볼빨간사춘기',
    match: '98%',
    rating: 'TWO FIVE',
